...
class SbtKernelManager:
    ...
    def set_exception_kernel(self, kernel: wp.Kernel | str) -> None: ...
    def add_callable_kernel(self, kernel: wp.Kernel | str, *, continuation: bool = False): ...
...
def create_pipeline_and_sbt(
    ...
    direct_callable_entries: list[wp.Kernel | str] | None = None,
    continuation_callable_entries: list[wp.Kernel | str] | None = None,
